...
public class AnduschainTransactionEncoder extends TransactionEncoder {
    private static final int CHAIN_ID_INC = 35;
    private static final int LOWER_REAL_V = 27;

    public static byte[] signMessage(AnduschainRawTransaction rawTransaction, Credentials credentials) {
    ...
    public static byte[] signMessage(
            AnduschainRawTransaction rawTransaction, long chainId, Credentials credentials) {
    ...
    @Deprecated
    public static byte[] signMessage(
            AnduschainRawTransaction rawTransaction, byte chainId, Credentials credentials) {
    ...
    public static byte[] encode(AnduschainRawTransaction rawTransaction) {
        return encode(rawTransaction, null);
    }

    public static byte[] encode(AnduschainRawTransaction rawTransaction, long chainId) {
        Sign.SignatureData signatureData =
    ...
    @Deprecated
    public static byte[] encode(AnduschainRawTransaction rawTransaction, byte chainId) {
        return encode(rawTransaction, (long) chainId);
    }

    private static byte[] encode(AnduschainRawTransaction rawTransaction, Sign.SignatureData signatureData) {
    ...
    public static List<RlpType> asRlpValues(
            AnduschainRawTransaction rawTransaction, Sign.SignatureData signatureData) {
